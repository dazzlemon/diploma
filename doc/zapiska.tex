...
82 с., 16 рис., 4 табл., 1 додаток, 101 джерело.
...
Мета --- розробка програмного забезпечення
...
% основну частину:
  ...
  В результаті (рис. \ref{fig:training_test}) бачимо що підбираются
  тільки ті з ключових слів, які присутні в обох списках ---
  наданому користувачем і підібраному програмою.
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{comparison_test.png}    
    \captionsetup{justification=centering}  
  ...
  Для більш наглядного порівняння можна представити ці дані у вигляді таблиці
  ...
  \centerline{ДОДАТОК А}
  \centerline{Вихідний код програми}
