...
% основну частину:
  ...
  переклад та перевірка точності перекладу текстів (наукових робіт)
  з натуральної мови на формальну (УДК шифр).
  ...
  необхідні для вибору та перевірки, а також мінімsізувати ризик помилок.
  Тому ця робота має на меті розробити надійний
  та ефективний автоматизований інструмент для вибору
  та перевірки УДК шифрів наукових робіт.
  ...
  Через розміри та семантику УДК шифрів,
